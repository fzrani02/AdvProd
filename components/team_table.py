...
def render_team_table(df, initial, departments, editable_col, attendance_data, member_data, title, key_prefix):
    ...
    with left:
        ...
        col1.markdown("<div style='text-align:center; font-weight:bold; font-size:20px;'>Department</div>", unsafe_allow_html=True)
        col2.markdown("<div style='text-align:center; font-weight:bold; font-size:20px;'>Name</div>", unsafe_allow_html=True)
        col3.markdown("<div style='text-align:center; font-weight:bold; font-size:20px;'>Ext. #</div>", unsafe_allow_html=True)
        col4.markdown("<div style='text-align:center; font-weight:bold; font-size:20px;'>Email</div>", unsafe_allow_html=True)
